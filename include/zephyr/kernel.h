 ...
 */
#define K_MEM_SLAB_IN_SECTION_DEFINE(name, section, slab_block_size, slab_num_blocks, slab_align,  \
				     ...)                                                          \
	char COND_CODE_1(IS_EMPTY(section), (__noinit_named(k_mem_slab_buf_##name)), (Z_GENERIC_SECTION(section)))                                                                           \
			Z_GENERIC_SECTION(section) __aligned(WB_UP(slab_align))                    \
...
#define K_MEM_SLAB_DEFINE(name, slab_block_size, slab_num_blocks, slab_align)                      \
	K_MEM_SLAB_IN_SECTION_DEFINE(name, EMPTY, slab_block_size, slab_num_blocks, slab_align)
 ...
 * @param slab_num_blocks Number memory blocks.
 * @param slab_align Alignment of the memory slab's buffer (power of 2).
 * @param section Memory section to locate the memory slab.
 */
#define K_MEM_SLAB_IN_SECTION_DEFINE_STATIC(name, section, slab_block_size, slab_num_blocks,       \
					    slab_align)                                            \
	static char COND_CODE_1(IS_EMPTY(section), (__noinit_named(k_mem_slab_buf_##name)), (Z_GENERIC_SECTION(section))) __aligned(WB_UP(slab_align))               \
			 _k_mem_slab_buf_##name[(slab_num_blocks) * WB_UP(slab_block_size)];       \
...
#define K_MEM_SLAB_DEFINE_STATIC(name, slab_block_size, slab_num_blocks, slab_align)               \
	K_MEM_SLAB_IN_SECTION_DEFINE_STATIC(name, EMPTY, slab_block_size, slab_num_blocks,         \
					    slab_align)
