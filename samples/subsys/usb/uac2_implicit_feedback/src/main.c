...
#define SAMPLE_FREQUENCY    (SAMPLES_PER_SOF * 8000)
 ...
 */
#define I2S_BLOCKS          7
K_MEM_SLAB_IN_SECTION_DEFINE_STATIC(i2s_tx_slab, I2S_MEMORY_SECTION, ROUND_UP(MAX_BLOCK_SIZE, UDC_BUF_ALIGN), I2S_BLOCKS, UDC_BUF_ALIGN);
K_MEM_SLAB_IN_SECTION_DEFINE_STATIC(i2s_rx_slab, I2S_MEMORY_SECTION, ROUND_UP(MAX_BLOCK_SIZE, UDC_BUF_ALIGN), I2S_BLOCKS, UDC_BUF_ALIGN);
